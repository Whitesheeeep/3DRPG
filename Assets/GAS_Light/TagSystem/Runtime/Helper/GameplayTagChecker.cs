namespace WS_Modules.GAS.TAG
{
    ...
    public static class GameplayTagChecker
    {
        ...
        public static bool HasAnyTag(GameplayTagContainer container, IGameplayTagContainer queries) => container != null && container.HasAny(queries);
        /// <summary>判断容器是否满足查询容器中的全部显式标签。</summary>
        public static bool HasAllTags(GameplayTagContainer container, IGameplayTagContainer queries) => container != null && container.HasAll(queries);
    }
}
