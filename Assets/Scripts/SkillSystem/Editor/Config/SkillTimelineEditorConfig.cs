...
namespace RPG.SkillSystem.Editor
{
    ...
    internal sealed class SkillTimelineEditorConfig : ScriptableObject
    {
        ...
        [Header("轨道内容")]
        [SerializeField, Min(1f)] private float markerWidth = 16f;
        ...
        public float MarkerWidth => markerWidth;
