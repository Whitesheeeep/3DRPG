...
namespace WS_Modules.UIModule
{
	...
	{
		#region 自定义字段
		public  Button ChatChoiceButton;

		public  TMP_Text ChatContentTMP_Text;
		...
		{
			//按钮事件自动注册绑定
			ChatChoiceButton.onClick.AddListener(OnChatChoiceButtonClick);
		}
		...
		#region UI组件事件
		private void OnChatChoiceButtonClick()
		{
