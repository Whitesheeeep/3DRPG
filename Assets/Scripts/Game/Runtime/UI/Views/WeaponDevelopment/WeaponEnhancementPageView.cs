...
{
    /// <summary>升级页面的等级、经验、属性、已选素材和费用表现。</summary>
    [DisallowMultipleComponent]
    [InfoBox("依赖升级页面 Root 内的等级经验文本、细型经验 Slider、属性文本、横向素材列表、费用区域和按钮。")]
    public sealed class WeaponEnhancementPageView : MonoBehaviour
    {
        #region 依赖字段
        ...
        public void ValidateConfiguration()
        {
            if (titleText == null || subtitleText == null || linesText == null || experienceSlider == null ||
                ...
                throw new InvalidOperationException("[WeaponEnhancementPageView] 升级页面存在未绑定控件。");
        ...
        public void Bind(WeaponEnhancementViewData data)
        {
        ...
        private static string FormatExperienceText(WeaponEnhancementViewData data)
        {
